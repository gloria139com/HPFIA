...
float fis(float *input_data_i, short number)
{
    ...
    drv_write32(0x2100, number);         
    drv_write32(0x2180, in_data0);       
    drv_write32(0x2184, in_data1);
    drv_write32(0x2188, in_data2);

   fpgaInitAndRun(&weight1);

    return weight1;
}


void fpgaInitAndRun(float *weight1)
{
    unsigned int end1;
    float r0;
    int r1;
    float r2, r3, r4;
    drv_write32(0x2120,1);                  
  
    
    for (int i=0; i<10000; i++)
    {
        end1 = drv_read32(0x2140);          
    ...
    r0 = drv_read32(0x2160);
    r1 = drv_read32(0x2160);
    r2 = r0/4096;
    r3 = ~(r1-1);
    r4 = r3/4096;
