...
float fis(float *input_data_i, short number)
{
    ...
    drv_write32(0x2118, number);          
    drv_write32(0x21e0, in_data0);      
    drv_write32(0x21e4, in_data1);
    drv_write32(0x21e8, in_data2);
  
 
   fpgaInitAndRun(&weight7);
...
void fpgaInitAndRun(float *weight7)
{
    unsigned int end7;
    float r0;
    int r1;
    float r2, r3, r4;
    drv_write32(0x2138,1);                

    for (int i=0; i<10000; i++)
    {
        end7 = drv_read32(0x2158);          
        if(end7==1)
        {
           break;
        }
    ...
    r0 = drv_read32(0x2178);
    r1 = drv_read32(0x2178);
    r2 = r0/4096;
    r3 = ~(r1-1);
    r4 = r3/4096;
