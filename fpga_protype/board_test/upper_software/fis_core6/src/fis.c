...
float fis(float *input_data_i, short number)
{
    ...
    drv_write32(0x2114, number);         
    drv_write32(0x21d0, in_data0);         
    drv_write32(0x21d4, in_data1);
    drv_write32(0x21d8, in_data2);

   fpgaInitAndRun(&weight6);
...
void fpgaInitAndRun(float *weight6)
{
    unsigned int end6;
    float r0;
    int r1;
    ...
    r0 = drv_read32(0x2174);
    r1 = drv_read32(0x2174);
    r2 = r0/4096;
    r3 = ~(r1-1);
    r4 = r3/4096;
